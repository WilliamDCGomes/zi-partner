...
extension ImageResource {
    ...
    static let devLaunch = ImageResource(name: "devLaunchImage", bundle: resourceBundle)

    /// The "hmlgLaunchImage" asset catalog image resource.
    static let hmlgLaunch = ImageResource(name: "hmlgLaunchImage", bundle: resourceBundle)

    /// The "prodLaunchImage" asset catalog image resource.
    static let prodLaunch = ImageResource(name: "prodLaunchImage", bundle: resourceBundle)
